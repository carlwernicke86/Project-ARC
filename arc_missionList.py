...
mission_list = [
    ...
    ("Intelligent Secure Solutions", "Maclaurin Group Warehouse #14", "Hard", ("None", ""), "$20000", None) #Mission 4
    ("Aegis Data Security", "Athena Electronics", "Hard", ("None", ""), "$20000", None) #Mission 5
]
