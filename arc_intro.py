...
from arc_credits import credits
...
def intro(screen, clock, fps, TIMER):
    ...
    #Click Text Objects
    New_Game = Click_Button(40, ORANGE, LIGHT_GREY, (screen.get_rect().centerx, screen.get_rect().centery/1.5), "Play", False, None, None, None, WHITE)
    ...
    Credits = Click_Button(40, ORANGE, LIGHT_GREY, (screen.get_rect().centerx, Options.rect.y + 65), "Credits", credits, None, None, None, WHITE)
    ...
    click_button_group.add(New_Game, Options, Credits)
