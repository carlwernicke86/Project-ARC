...
def mission04(intro_flag = False):
    ...
    try:
        ...
        pygame.mixer.music.load("Sounds/DullPianoSong.ogg")
    ...
    level4 = Regular_Text(100, BLACK, (screen.get_rect().centerx, screen.get_rect().centery/2), "Level 4")
